...
elseif Place == 0x0001 and not Events(0x39,0x39,0x39) then --Post Xemnas II Cutscenes
	...
	if ReadShort(Save+0x1BAC) == 0x03 then --Saved Spawn ID that's altered after opening the final dooR
		WriteShort(Save+0x1B7C,0x0D) --The Altar of Naught MAP (Data Door)
...
--Skip Chasing Jafar's Water Clone (only 1 Cutscene Skip Needed)
if Place == 0x0E07 and ReadShort(Save+0x0AE8) == 0x0D then
