...
if not OnPC then
	WriteInt(0x264250,0)
elseif ReadArray(0x2F9302-0x56454E) == {0x41,0x85,0xD6,0x74,0x0D,0x0F,0xB7,0x43} then --Global
	WriteByte(0x2F9306 - 0x56454E,0)
elseif ReadArray(0x2F9142-0x56454E) == {0x41,0x85,0xD6,0x74,0x0D,0x0F,0xB7,0x43} then --JP
